...
$query = mysqli_query($conn, "SELECT * FROM produk WHERE kategori = 'eyeglasses' ORDER BY id DESC");
?>
...
<head>
  <meta charset="UTF-8">
  <title>Eyeglasses - FLACKO AND GLASSES</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="style.css"> 
  <a href="detail.php?id=<?= $row['id'] ?>" class="btn btn-outline-dark">Lihat Detail</a>
...
<?php include 'navbar.php'; ?>
  ...
  <h2 class="text-center mb-5">Kategori: Eyeglasses</h2>
  <div class="row">
